...
const resolvers = {
  Query: {
    ...
    getProduct(parent, args, context, info) {
      return find(JSON.parse(localStorage.getItem("products")), {
        id: args.id,
      });
    },
    getCustomer(parent, args, context, info) {
      return find(JSON.parse(localStorage.getItem("customers")), {
        id: args.id,
      });
    },
  ...
  Mutation: {
    ...
    deleteProduct(parent, args, context, info) {
      ...
      localStorage.setItem(
        "products",
        JSON.stringify(products.filter((i) => i.id !== args.id))
      );
